-- Make canonical exterior-environment refresh re-entrant within a single transaction.
-- Production-live definition captured after regression testing.
...
begin
  ...
  -- Make repeated classifier/verification refreshes safe inside one transaction.
  drop table if exists pg_temp._scout_env_bridge;
  ...
  select canonical_id,
    ...
    jsonb_strip_nulls(jsonb_build_object(
      'bridge_version','fema-overlap-v1','source_population','fema-usa-structures-current',
