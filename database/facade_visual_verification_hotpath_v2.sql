-- Scout by Cadastory
-- Final production hot path for structured facade/glazing verification.
-- Uses incremental service-classification deltas; full classifier rebuild remains tied to opportunity-spine refresh.

DROP FUNCTION IF EXISTS scout.refresh_exterior_opportunity_service_classifications_for_building(uuid);
...
begin
  ...
  return jsonb_build_object(
    ...
    'facade_material',v_material,'glazing_signal',v_glazing,'confidence',v_conf,
