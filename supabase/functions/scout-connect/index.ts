...
const SANDBOX_RESOURCE_URI = SCOUT_SANDBOX_RESOURCE_URI
const SANDBOX_COMPATIBILITY_RESOURCE_URIS = scoutSandboxCompatibilityResourceUris()
...
function sandboxTool(){return {name:SANDBOX_TOOL,title:'Preview Scout opportunity card',description:scoutSandboxToolDescription(),inputSchema:sandboxOpportunityTypeInputSchema(),outputSchema:sandboxResultSchema(),annotations:{readOnlyHint:true,destructiveHint:false,idempotentHint:true,openWorldHint:false},_meta:{ui:{resourceUri:SANDBOX_RESOURCE_URI}}}}
