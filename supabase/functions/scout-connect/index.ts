...
const SANDBOX_RESOURCE_URI = 'ui://scout/component-sandbox/v24'
const SANDBOX_COMPATIBILITY_RESOURCE_URIS = ['ui://scout/component-sandbox/v23','ui://scout/component-sandbox/v22','ui://scout/component-sandbox/v21','ui://scout/component-sandbox/v20','ui://scout/component-sandbox/v19','ui://scout/component-sandbox/v18','ui://scout/component-sandbox/v17','ui://scout/component-sandbox/v16','ui://scout/component-sandbox/v15','ui://scout/component-sandbox/v14','ui://scout/component-sandbox/v13','ui://scout/component-sandbox/v12','ui://scout/component-sandbox/v11','ui://scout/component-sandbox/v10','ui://scout/component-sandbox/v9','ui://scout/component-sandbox/v8','ui://scout/component-sandbox/v7','ui://scout/component-sandbox/v6','ui://scout/component-sandbox/v5','ui://scout/component-sandbox/v4','ui://scout/component-sandbox/v3','ui://scout/component-sandbox/v2','ui://scout/component-sandbox/v1']
...
function sandboxTool(){return {name:SANDBOX_TOOL,title:'Preview Scout opportunity card',description:'Owner-only read-only developer tool that renders one bounded Scout MCP Apps opportunity card and matching single-site map. Select premium_exterior, water_tank, or swppp_site; omission preserves the PNC Tower compatibility default.',inputSchema:{type:'object',properties:{opportunity_type:{type:'string',enum:['premium_exterior','water_tank','swppp_site']}},additionalProperties:false},outputSchema:sandboxResultSchema(),annotations:{readOnlyHint:true,destructiveHint:false,idempotentHint:true,openWorldHint:false},_meta:{ui:{resourceUri:SANDBOX_RESOURCE_URI}}}}
