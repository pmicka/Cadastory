import type { ScoutDealershipPortfolioResolutionState, ScoutSandboxDealershipPortfolioMap } from './dealership_portfolio_map_model.ts'
...
export type ScoutDealershipPortfolioRasterTile = {
  z: number
  x: number
  y: number
  left: number
...
export type ScoutDealershipPortfolioMarker = {
  left: number
  top: number
  name: string
  brands: string[]
  resolutionState: ScoutDealershipPortfolioResolutionState
  resolvedBuildingCount: number
}

export type ScoutDealershipPortfolioRasterFrame = {
  zoom: number
  width: number
  height: number
  tiles: ScoutDealershipPortfolioRasterTile[]
  markers: ScoutDealershipPortfolioMarker[]
}

export type ScoutDealershipPortfolioRasterFrameOptions = {
...
export function buildScoutDealershipPortfolioRasterFrame(
  data: ScoutSandboxDealershipPortfolioMap,
  width: number,
  height: number,
  options: ScoutDealershipPortfolioRasterFrameOptions,
): ScoutDealershipPortfolioRasterFrame {
  ...
  const tiles: ScoutDealershipPortfolioRasterTile[] = []
  ...
  const markers: ScoutDealershipPortfolioMarker[] = []
  for (const member of data.members) {
    ...
    markers.push({
      ...
      resolutionState: member.resolution_state,
      resolvedBuildingCount: member.resolved_building_count,
    })
  }
