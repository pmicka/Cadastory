...
const smokeTestByType = {
  ...
  rail_crossing: 'spine_single_asset_map_renderer_test.mjs',
  roof_lifecycle: 'spine_single_asset_map_renderer_test.mjs',
  solar_lifecycle: 'spine_single_asset_map_renderer_test.mjs',
