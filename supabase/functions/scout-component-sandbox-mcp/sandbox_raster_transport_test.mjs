...
assert.ok(serverSource.includes('isScoutSandboxSingleSiteType(selectedType)'))
assert.ok(serverSource.includes('scoutSandboxSingleSiteImplementation(selectedType)'))
assert.ok(serverSource.includes("'scout/rasterTiles': await loadEmbeddedRasterTilesForSelection(selectedType, map)"))
