import type { ScoutHotelPortfolioResolutionState, ScoutSandboxHotelPortfolioMap } from './hotel_portfolio_map_model.ts'
...
export type ScoutHotelPortfolioRasterTile = {
  z: number
  x: number
  y: number
  left: number
...
export type ScoutHotelPortfolioMarker = {
  left: number
  top: number
  name: string
  brands: string[]
  resolutionState: ScoutHotelPortfolioResolutionState
  resolvedBuildingCount: number
}

export type ScoutHotelPortfolioRasterFrame = {
  zoom: number
  width: number
  height: number
  tiles: ScoutHotelPortfolioRasterTile[]
  markers: ScoutHotelPortfolioMarker[]
}

export type ScoutHotelPortfolioRasterFrameOptions = {
...
function fitZoom(
  data: ScoutSandboxHotelPortfolioMap,
  width: number,
  height: number,
  minZoom: number,
  maxZoom: number,
...
export function buildScoutHotelPortfolioRasterFrame(
  data: ScoutSandboxHotelPortfolioMap,
  width: number,
  height: number,
  options: ScoutHotelPortfolioRasterFrameOptions,
): ScoutHotelPortfolioRasterFrame {
  ...
  const tiles: ScoutHotelPortfolioRasterTile[] = []
  ...
  const markers: ScoutHotelPortfolioMarker[] = []
