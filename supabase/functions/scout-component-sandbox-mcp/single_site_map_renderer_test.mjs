...
assert.ok(view.includes("https://a.tile.openstreetmap.fr/hot/{z}/{x}/{y}.png"))
...
assert.ok(server.includes("const MAP_TILE_ORIGIN = 'https://a.tile.openstreetmap.fr'"))
...
assert.ok(server.includes("const RESOURCE_URI = 'ui://scout/component-sandbox/v18'"))
