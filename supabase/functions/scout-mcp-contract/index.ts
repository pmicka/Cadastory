...
const SANDBOX_RESOURCE_URI = 'ui://scout/component-sandbox/v9'
const SANDBOX_COMPATIBILITY_RESOURCE_URIS = ['ui://scout/component-sandbox/v8','ui://scout/component-sandbox/v7','ui://scout/component-sandbox/v6','ui://scout/component-sandbox/v5','ui://scout/component-sandbox/v4','ui://scout/component-sandbox/v3','ui://scout/component-sandbox/v2','ui://scout/component-sandbox/v1']
...
function sandboxTool(){return {name:SANDBOX_TOOL,title:'Preview Scout UI Foundation',description:'Owner-only read-only developer tool that renders the minimal Scout MCP Apps View with a bounded set of real Scout exemplars. Call only when the Scout owner explicitly asks to test or preview the Scout sandbox UI foundation.',inputSchema:{type:'object',properties:{},additionalProperties:false},outputSchema:{type:'object',properties:{surface:{type:'string',enum:['scout_component_sandbox']},names:{type:'array',maxItems:2,items:{type:'string',minLength:1,maxLength:160}}},required:['surface','names'],additionalProperties:false},annotations:{readOnlyHint:true,destructiveHint:false,idempotentHint:true,openWorldHint:false},_meta:{ui:{resourceUri:SANDBOX_RESOURCE_URI}}}}
