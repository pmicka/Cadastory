...
'Returns the private neutral-evidence inventory for Farm Watch UI presentation, including production-validated study-aligned vegetation height. It exposes current product metadata/summaries and dated Surface Water State without producing deer-use inference or scores.';
